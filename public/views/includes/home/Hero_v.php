  ...
  <div class="relative isolate overflow-hidden pt-14">
	...
	/>
      <div class="text-center">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="#" class="rounded-sm bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary">Ver cursos</a>
          <a href="#" class="text-sm font-semibold leading-6 text-white">¿Cómo funciona?<span aria-hidden="true">→</span></a>
        </div>
      </div>
    </div>
    <div class="mx-auto grid max-w-lg grid-cols-2 items-center gap-x-8 gap-y-10 py-20 sm:max-w-xl sm:grid-cols-3 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
		...
		<img
			...
			src="assets/img/images/home/cudd.png"
			alt="cudd"
			width={158}
			height={48}
		/>
		<img
			...
			src="assets/img/images/home/+uach.png"
			alt="+uach"
			width={158}
			height={48}
		/>
