...
<!-- <div class="hidden md:block relative">
    ...
    <div class="container mx-auto md:grid md:grid-cols-2 gap-3 text-white py-5">
        ...
        <div class="grid grid-flow-row-dense gap-4 px-5 md:px-0">
            ...
            <div class="grid grid-flow-row md:grid-cols-2 gap-4 text-gray-400">
                <a class="link" href="http://transparencia.uach.mx/">Transparencia</a>
...
<footer class="bg-purpleuach md:grid md:grid-cols-2 pt-10">
    ...
    <div class="text-center text-white py-4">
        <div>
            ...
            <div class="grid grid-flow-row gap-4 md:grid-cols-2 text-gray-400 text-sm text-left ml-3 mt-2 ">
                <a class="Link" href="http://transparencia.uach.mx/">Transparencia</a>
                <a class="Link" href="https://uach.mx/noticias/">Sala de prensa</a>
                <a class="Link" href="https://uach.mx/eventos/">Eventos</a>
                <a class="Link" href="https://uach.mx/estudiantes/movilidad-estudiantil/">Estudia en el extranjero</a>
