...
<body class="font-[Poppins] min-h-screen flex flex-col justify-start">
    ...
    <nav class="flex items-center justify-between px-12 h-16 lg:gap-5 bg-[#45484c] border-gray-200">
        <a href="<?= base_url ?>" class="flex items-center">
            <img src="https://teachers-xi.vercel.app/images/logo-white.png" class="h-6 mr-3 sm:h-12">
        </a>
            ...
            <ul class="text-white flex flex-col lg:flex-row items-start gap-6 hover:transition-all">
                <?php if (isset($_SESSION['identidad'])) : ?>
                    <?php if (isset($_SESSION['admin'])) : ?>
                        <li>
                            <a href="<?= htmlspecialchars(base_url) ?>" class="block py-2 pl-3 pr-4 text-white rounded hover:text-[#D5175E]  lg:p-0" hover:text-[#D5175E] aria-current="page">Mis talleres</a>
                        </li>
                        <li>
                            <a href="<?= htmlspecialchars(base_url . "Page/carreras") ?>" class="block py-2 pl-3 pr-4 text-white rounded hover:text-[#D5175E]  lg:p-0">Rutas de aprendizaje</a>
                        </li>
